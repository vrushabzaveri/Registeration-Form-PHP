...
if(in_array($fileType, $allowTypes)){
	...
	if(move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $targetFilePath)){
		 ...
		 $insert = "INSERT INTO users (first_name, last_name, email, contact_number, dob,location_id,active,img_file) VALUES ('$first_name', 
		    '$last_name','$email','$contact_number','$dob', '$location_id','$active', '$fileName')";
